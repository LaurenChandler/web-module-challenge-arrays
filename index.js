...
2 arguments one for your new array and one for your original array
...
function copy(arr, newarr){
 ...
 console.log(copy(originalFlavors, 'Same Flavors')) ;
...
Write a function that checks every item in the array for a given string 
